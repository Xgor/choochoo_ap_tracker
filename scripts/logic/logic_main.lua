...
function choo-choo_charles_location.new(name)
    local self = setmetatable({}, choo-choo_charles_location)
    if name then
...
function choo-choo_charles_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = choo-choo_charles_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
function choo-choo_charles_location:connect_two_ways(exit, rule)
...
function choo-choo_charles_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function choo-choo_charles_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function choo-choo_charles_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function choo-choo_charles_location:connect_two_ways_stuck(exit, rule1, rule2)
...
function choo-choo_charles_location:accessibility()
...
-- 
function choo-choo_charles_location:discover(accessibility, keys)
...
entry_point = choo-choo_charles_location.new("entry_point")
